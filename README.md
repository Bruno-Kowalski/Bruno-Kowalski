...
<p align="left">
Estudante de Análise e Desenvolvimento de Sistemas com experiência prática em suporte técnico e processos administrativos.
Experiência com desenvolvimento Front-End e Back-End, atuo na criação de interfaces intuitivas e soluções completas,
com foco em usabilidade, performance e qualidade de código. Busco oportunidades de estágio ou posição júnior para
contribuir no desenvolvimento de aplicações responsivas e eficientes, aplicando conhecimentos em Java, Go, Node.js,
React, Next.js, Vue.js, bancos de dados MySQL e SQL Server, sempre aliado a boas práticas de versionamento e metodologias ágeis.
...
<b>Skills:</b><br>
 ...
 • Outras skills: Docker, Supabase, Git, APIs REST
</p>
